 ...
 */
export let jstz: any = (function(): any {
   ...
   * @returns {Number}
   */
  var get_date_offset = function get_date_offset(date): any {
   ...
   * @returns {String}
   */
  var lookup_key = function lookup_key(): any {
   ...
   */
  var get_from_internationalization_api = function get_from_internationalization_api(): any {
    var format, timezone;
    if (
   ...
   */
  var dst_dates = function dst_dates(year): any {
   ...
   * @returns {Date}
   */
  var find_dst_fold = function find_dst_fold(a_date, padding?, iterator?): any {
  ...
  var windows7_adaptations = function windows7_adaptions(
    rule_list,
   ...
   * @returns {*}
   */
  var best_dst_match = function best_dst_match(
    rule_list,
    preliminary_timezone
  ): any {
   ...
   */
  var get_by_dst = function get_by_dst(preliminary_timezone): any {
   ...
   * @returns Object
   */
  var determine = function determine(): any {
