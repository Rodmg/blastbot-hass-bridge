...
if (config.log.logToFiles) {
  const logDir = path.join(process.env.HOME, ".deleteme-logs");
  ...
  log.add(winston.transports.File, {
    name: "error-file",
    level: "error",
    filename: path.join(logDir, "deleteme-error.log"),
    json: true,
  });
  ...
  log.add(winston.transports.File, {
    name: "warn-file",
    level: "warn",
    filename: path.join(logDir, "deleteme-warn.log"),
    json: true,
  });
  ...
  log.add(winston.transports.File, {
    name: "debug-file",
    level: "debug",
    filename: path.join(logDir, "deleteme-debug.log"),
    json: true,
  });
  ...
  requestLog.add(winston.transports.File, {
    name: "request-file",
    level: "info",
    filename: path.join(logDir, "deleteme-requests.log"),
    json: true,
  });
}
